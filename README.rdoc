...
* RDoc: http://aef.rubyforge.org/migrator/
* Github: http://github.com/aef/migrator/

== DESCRIPTION:

Migrator is a Ruby library and commandline tool to help with simple task of
renaming or copying files for quick backup purposes. For instance by creating
a copy of a list of files while adding .bak to the copies filenames. Migrator
